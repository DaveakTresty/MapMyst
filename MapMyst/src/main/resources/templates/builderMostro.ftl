...
<head>
    ...
    <title>Builder Mostro</title>
    <link rel="icon" type="image/png" href="/img/MapMystLogo.png">
    <link rel="stylesheet" href="css/styleBuilderMostroGenerale.css">
    <link rel="stylesheet" href="css/styleBuilderMostroScheda.css">
    <link rel="stylesheet" href="css/styleBuilderMostroStat.css">
    <link rel="stylesheet" href="css/styleBuilderMostroTratti.css">
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="formStatistiche">
            ...
            <div id="infogenerali">
                ...
                <!-- Nome -->
                <input type="text" placeholder=" Nome del mostro" id="nomeMostro">
                <!-- Livello -->
                <input type="number" placeholder=" Livello" min="1" max="40" id="livello">
                <!-- Ruolo -->
                <select id="ruolo">
                    <option disabled selected value="">Ruolo</option>
                    <option value="Appostato">Appostato</option>
                    <option value="Artigliere">Artigliere</option>
                    <option value="Bruto">Bruto</option>
                    <option value="Controllore">Controllore</option>
                    <option value="Schermagliatore">Schermagliatore</option>
                    <option value="Soldato">Soldato</option>
                </select>
                <!-- Gruppo -->
                <select id="gruppo">
                    <option disabled selected value="">Gruppo</option>
                ...
                <div>
                    <!-- Sottoruolo di guida -->
                    <label for="guida"> Guida&nbsp</label>
                ...
                <div>
                    <!-- Impulsi curativi -->
                    <label for="impulsi">Impulsi&nbsp</label>
                    <input type="checkbox" id="impulsi">
                </div>
            ...
            <div id="builder-statistiche-menu">
                ...
                <button id="salvaScheda">Salva il mostro nell'archivio</button>
            </div>
        </div>
        ...
        <div id="scheda">
            ...
            <div id="scheda-header">
                <!-- Nome -->
                <p id="nomeMostroScheda" class="scheda-bold">Nome del mostro</p>
                <p class="scheda-dx scheda-bold">
                    ...
                    <!-- Status -->
                    <span id="boxStatus"><span id="gruppoScheda">Status</span></span>
                    <!-- Guida -->
                    <span id="boxGuida"><span id="guidaScheda">(guida)</span></span>
                </p>
                <p>
                    <!-- Tipo -->
        ...
        <div id="token">
            <form method="POST" enctype="multipart/form-data" action="/salvaCreatura" id="formInvioFinale" style="display: none;">
                ...
                <input type="text" id="invioGruppo" name="gruppo">
    ...
    <script type="text/javascript" src="js/scriptBuilderMostro.js"></script>
