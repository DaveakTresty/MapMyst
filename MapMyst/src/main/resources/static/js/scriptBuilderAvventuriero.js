...
function statistichePrimarie() {
    ...
    if (!statisticheEsistono()) {
        errore("Devi prima selezionare livello e ruolo.");
    } else {

        // Calcolo delle difese base
        tempra.value = 13 + parseInt(livello.value);
        riflessi.value = 13 + parseInt(livello.value);
        volonta.value = 13 + parseInt(livello.value);

        // Calcolo della Classe armatura
        switch (ruolo.value) {
            case "Assalitore":
                ca.value = 15 + parseInt(livello.value);
                break;
            case "Controllore":
                ca.value = 13 + parseInt(livello.value);
                break;
            case "Difensore":
                ca.value = 17 + parseInt(livello.value);
                break;
            case "Guida":
                ca.value = 15 + parseInt(livello.value);
                break;
        ...
        switch (ruolo.value) {
            case "Assalitore":
                pf.value = 19 + (5 * parseInt(livello.value));
                break;
            case "Controllore":
                pf.value = 17 + (4 * parseInt(livello.value));
                break;
            case "Difensore":
                pf.value = 24 + (6 * parseInt(livello.value));
                break;
            case "Guida":
                pf.value = 19 + (5 * parseInt(livello.value));
                break;
        ...
        switch (ruolo.value) {
            case "Assalitore":
                impulsiCurativi.value = 7 + (parseInt(modCos.value));
                valoreImpulso.value = Math.floor(pf.value / 4);
                break;
            case "Controllore":
                impulsiCurativi.value = 6 + (parseInt(modCos.value));
                valoreImpulso.value = Math.floor(pf.value / 4);
                break;
            case "Difensore":
                impulsiCurativi.value = 11 + (parseInt(modCos.value));
                valoreImpulso.value = Math.floor(pf.value / 4);
                break;
            case "Guida":
                impulsiCurativi.value = 8 + (parseInt(modCos.value));
                valoreImpulso.value = Math.floor(pf.value / 4);
                break;
        }
    }
...
function aggiornaMod() {
    ...
    if(!livello || !forza || !costituzione || !destrezza || !intelligenza || !saggezza || !carisma) {
        ...
        // Calcolo del modificatore di Percezione e Iniziativa
        percezione.value = modSag.value;
        iniziativa.value = segno(parseInt(modDes.value));

        // Ricalcolo impulsi curativi e valore dell'impulso
        switch (ruolo.value) {
            case "Assalitore":
                impulsiCurativi.value = 7 + (parseInt(modCos.value));
                valoreImpulso.value = Math.floor(pf.value / 4);
...
function aggiungiPotere(idGenerato) {
    ...
    let calcolaDanno = document.createElement("button");
            ...
            calcolaDanno.addEventListener("click", function() {
                ...
                let ricarica = document.getElementById("ricarica-" + idGenerato).value;
                let difesaAttaccata = document.getElementById("difesaAttaccata-" + idGenerato).value;
                let tipoDanni = document.getElementById("tipoDanni-" + idGenerato).value;
                let numeroBersagli = document.getElementById("numeroBersagli-" + idGenerato).value;
                let tipoPotere = document.getElementById("tipoPotere-" + idGenerato).value;

                // Controllo che l'utente abbia selezionato un tipo di ricarica
                if (ricarica === "" || tipoPotere === "" || tipoDanni === "" || numeroBersagli === "") {
                    errore("Devi prima selezionare il tipo di attacco e di ricarica, il numero di bersagli e il tipo dei danni.");
                } else {
                    // Calcolo danno medio
                    ...
                    if(difesaAttaccata === "ca") {
                        attaccoSuggerito = 6 + parseInt(livello.value);
                    } else {
                        attaccoSuggerito = 4 + parseInt(livello.value);
                    }

                    // Calcolo percentuale da applicare ai danni
                    let percentuale = 0;
                    if (numeroBersagli === "multipli") {percentuale -= 25;}
                    if (ricarica != "nessuna" && ricarica != "volonta") {percentuale += 25;}
                    if (tipoDanni === "elevati") {percentuale += 25;}
...
function generaScheda() {
    ...
    if (
        ...
        // Inserimento di impulsi curativi e valori impulso
        ...
        nomeMostro.style.backgroundColor = "#86b8e7";
        origine.style.backgroundColor = "#86b8e7";
        tipoMostro.style.backgroundColor = "#86b8e7";
        taglia.style.backgroundColor = "#86b8e7";
        livello.style.backgroundColor = "#86b8e7";
        ruolo.style.backgroundColor = "#86b8e7";
        pf.style.backgroundColor = "#86b8e7";
        ca.style.backgroundColor = "#86b8e7";
        tempra.style.backgroundColor = "#86b8e7";
        riflessi.style.backgroundColor = "#86b8e7";
        volonta.style.backgroundColor = "#86b8e7";
        forza.style.backgroundColor = "#86b8e7";
        costituzione.style.backgroundColor = "#86b8e7";
        destrezza.style.backgroundColor = "#86b8e7";
        intelligenza.style.backgroundColor = "#86b8e7";
        saggezza.style.backgroundColor = "#86b8e7";
        carisma.style.backgroundColor = "#86b8e7";
        modFor.style.backgroundColor = "#86b8e7";
        modCos.style.backgroundColor = "#86b8e7";
        modDes.style.backgroundColor = "#86b8e7";
        modInt.style.backgroundColor = "#86b8e7";
        modSag.style.backgroundColor = "#86b8e7";
        modCar.style.backgroundColor = "#86b8e7";
        velocita.style.backgroundColor = "#86b8e7";
        iniziativa.style.backgroundColor = "#86b8e7";
        percezione.style.backgroundColor = "#86b8e7";
...
function salvaScheda() {
    if(document.getElementById("inputToken").value && schedaGenerata) {
        ...
        errore("Genera una scheda e carica un token prima di salvare l'avventuriero nell'archivio.");
    }
}
...
function inoltraForm() {
    if(inputScheda) {
        ...
        document.getElementById("invioPe").value = "0";
